...
def test_net(data_path, batch_size, device, dataset_train, dataset_test, image_size, job_name, threshold, checkpoint_mode, mask_or=True, train_or=False):
    ...
    dir_checkpoint_1="./M2_Vessel_seg/Saved_model/train_on_{}/{}_savebest_randomseed_{}/".format(dataset_train,job_name,24)
    dir_checkpoint_2="./M2_Vessel_seg/Saved_model/train_on_{}/{}_savebest_randomseed_{}/".format(dataset_train,job_name,26)
    dir_checkpoint_3="./M2_Vessel_seg/Saved_model/train_on_{}/{}_savebest_randomseed_{}/".format(dataset_train,job_name,28)
    dir_checkpoint_4="./M2_Vessel_seg/Saved_model/train_on_{}/{}_savebest_randomseed_{}/".format(dataset_train,job_name,30)
    dir_checkpoint_5="./M2_Vessel_seg/Saved_model/train_on_{}/{}_savebest_randomseed_{}/".format(dataset_train,job_name,32)
    dir_checkpoint_6="./M2_Vessel_seg/Saved_model/train_on_{}/{}_savebest_randomseed_{}/".format(dataset_train,job_name,34)
    dir_checkpoint_7="./M2_Vessel_seg/Saved_model/train_on_{}/{}_savebest_randomseed_{}/".format(dataset_train,job_name,36)
    dir_checkpoint_8="./M2_Vessel_seg/Saved_model/train_on_{}/{}_savebest_randomseed_{}/".format(dataset_train,job_name,38)
    dir_checkpoint_9="./M2_Vessel_seg/Saved_model/train_on_{}/{}_savebest_randomseed_{}/".format(dataset_train,job_name,40)
    dir_checkpoint_10="./M2_Vessel_seg/Saved_model/train_on_{}/{}_savebest_randomseed_{}/".format(dataset_train,job_name,42)
