...
if os.path.exists(
    "/home/jupyter/Deep_rias/Results/M2/artery_vein/artery_binary_skeleton/.ipynb_checkpoints"
):
    shutil.rmtree(
        "/home/jupyter/Deep_rias/Results/M2/artery_vein/artery_binary_skeleton/.ipynb_checkpoints"
    )
if os.path.exists(
    "/home/jupyter/Deep_rias/Results/M2/binary_vessel/binary_skeleton/.ipynb_checkpoints"
):
    shutil.rmtree(
        "/home/jupyter/Deep_rias/Results/M2/binary_vessel/binary_skeleton/.ipynb_checkpoints"
    )
if os.path.exists(
    "/home/jupyter/Deep_rias/Results/M2/artery_vein/vein_binary_skeleton/.ipynb_checkpoints"
):
    shutil.rmtree(
        "/home/jupyter/Deep_rias/Results/M2/artery_vein/vein_binary_skeleton/.ipynb_checkpoints"
    )
...
for filename in sorted(glob.glob(os.path.join(CONFIG.image_directory, "*.png"))):
    segmentedImage = retina.Retina(
        None,
        filename,
        store_path="/home/jupyter/Deep_rias/Results/M2/binary_vessel/binary_process",
    )
    ...
    Data4stage2.to_csv(
        f"{AUTOMORPH_DATA}/Results/M3/Width/width_results_{segmentedImage._file_name}.csv",
        index=None,
        encoding="utf8",
    )
...
Data4stage2 = pd.DataFrame(
    {
        "Distance_Tortuosity": t2_list,
        "Squared_Curvature_Tortuosity": t4_list,
        "Tortuosity_density": t5_list,
    }
)
Data4stage2 = pd.concat([Exit_file, Data4stage2], axis=1)
Data4stage2.to_csv(
    f"{AUTOMORPH_DATA}/Results/M3/Binary_Tortuosity_Measurement.csv",
    index=None,
    encoding="utf8",
)
...
for filename in sorted(glob.glob(os.path.join(Artery_PATH, "*.png"))):
    segmentedImage = retina.Retina(
        None,
        filename,
        store_path="/home/jupyter/Deep_rias/Results/M2/artery_vein/artery_binary_process",
    )
    # segmentedImage.threshold_image()
    # segmentedImage.reshape_square()
    # window_sizes = segmentedImage.get_window_sizes()
    ...
    Data4stage2 = pd.DataFrame({"Order": vessel_count_list, "Width": w1_list})
    Data4stage2.to_csv(
        f"{AUTOMORPH_DATA}/Results/M3/Width/artery_width_results_{segmentedImage._file_name}.csv",
        index=None,
        encoding="utf8",
    )
...
Data4stage2 = pd.concat([Exit_file, Data4stage2], axis=1)
Data4stage2.to_csv(
    f"{AUTOMORPH_DATA}/Results/M3/Artery_Tortuosity_Measurement.csv",
    index=None,
    encoding="utf8",
)
...
for filename in sorted(glob.glob(os.path.join(Vein_PATH, "*.png"))):
    ...
    Data4stage2 = pd.DataFrame({"Order": vessel_count_list, "Width": w1_list})
    Data4stage2.to_csv(
        f"{AUTOMORPH_DATA}/Results/M3/Width/vein_width_results_{segmentedImage._file_name}.csv",
        index=None,
        encoding="utf8",
    )
...
Data4stage2 = pd.concat([Exit_file, Data4stage2], axis=1)
Data4stage2.to_csv(
    f"{AUTOMORPH_DATA}/Results/M3/Vein_Tortuosity_Measurement.csv",
    index=None,
    encoding="utf8",
)
