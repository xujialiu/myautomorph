...
Disc_all = Disc_whole_image.merge(
    Disc_zone,
    how="outer",
    on=[
        "Name",
...
Macular_all = Macular_whole_image.merge(
    Macular_zone,
    how="outer",
    on=[
        "Name",
