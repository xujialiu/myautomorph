...
if __name__ == '__main__':
    ...
    checkpoint_path_1 = './M1_Retinal_Image_quality_EyePACS/{}/{}/{}/7_seed_28/best_loss_checkpoint.pth'.format(args.task, args.load, args.model )
    checkpoint_path_2 = './M1_Retinal_Image_quality_EyePACS/{}/{}/{}/6_seed_30/best_loss_checkpoint.pth'.format(args.task, args.load, args.model  )
    checkpoint_path_3 = './M1_Retinal_Image_quality_EyePACS/{}/{}/{}/5_seed_32/best_loss_checkpoint.pth'.format(args.task, args.load, args.model  )
    checkpoint_path_4 = './M1_Retinal_Image_quality_EyePACS/{}/{}/{}/4_seed_34/best_loss_checkpoint.pth'.format(args.task, args.load, args.model  )
    checkpoint_path_5 = './M1_Retinal_Image_quality_EyePACS/{}/{}/{}/3_seed_36/best_loss_checkpoint.pth'.format(args.task, args.load, args.model  )
    checkpoint_path_6 = './M1_Retinal_Image_quality_EyePACS/{}/{}/{}/2_seed_38/best_loss_checkpoint.pth'.format(args.task, args.load, args.model  )
    checkpoint_path_7 = './M1_Retinal_Image_quality_EyePACS/{}/{}/{}/1_seed_40/best_loss_checkpoint.pth'.format(args.task, args.load, args.model  )
    checkpoint_path_8 = './M1_Retinal_Image_quality_EyePACS/{}/{}/{}/0_seed_42/best_loss_checkpoint.pth'.format(args.task, args.load, args.model  )
