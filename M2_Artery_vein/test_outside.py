...
if __name__ == '__main__':
    ...
    checkpoint_saved_1="./M2_Artery_vein/ALL-AV/{}_{}/Discriminator_unet/".format( args.jn,28)
    checkpoint_saved_2="./M2_Artery_vein/ALL-AV/{}_{}/Discriminator_unet/".format( args.jn,30)
    checkpoint_saved_3="./M2_Artery_vein/ALL-AV/{}_{}/Discriminator_unet/".format( args.jn,32)
    checkpoint_saved_4="./M2_Artery_vein/ALL-AV/{}_{}/Discriminator_unet/".format( args.jn,34)
    checkpoint_saved_5="./M2_Artery_vein/ALL-AV/{}_{}/Discriminator_unet/".format( args.jn,36)
    checkpoint_saved_6="./M2_Artery_vein/ALL-AV/{}_{}/Discriminator_unet/".format( args.jn,38)
    checkpoint_saved_7="./M2_Artery_vein/ALL-AV/{}_{}/Discriminator_unet/".format( args.jn,40)
    checkpoint_saved_8="./M2_Artery_vein/ALL-AV/{}_{}/Discriminator_unet/".format( args.jn,42)
